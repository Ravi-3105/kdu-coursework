...
public class MainTest {
    ...
    public void testParseCSV() throws IOException {
        // check for coins.csv
        Path coinCsvPath = Path.of("backend/assignments/1/crypto/src/test/resources/coins.csv");
        ...
        Path traderCsvPath = Path.of("backend/assignments/1/crypto/src/test/resources/traders.csv");
    ...
    public void testConcurrentTransactions() {
        ...
        transactionArray = Main.parseJsonFile("backend/assignments/1/crypto/src/test/resources/test_transaction_1.json");
    ...
    public void testConcurrentTransactions1() {
        ...
        transactionArray = Main.parseJsonFile("backend/assignments/1/crypto/src/test/resources/test_transaction_2.json");
    ...
    public void testConcurrentTransactionsMediumFile() {
        ...
        transactionArray = Main.parseJsonFile("backend/assignments/1/crypto/src/test/resources/test_transaction_3.json");
    ...
    public void testConcurrentTransactionsLargeFile() {
        ...
        transactionArray = Main.parseJsonFile("backend/assignments/1/crypto/src/test/resources/test_transaction_4.json");
